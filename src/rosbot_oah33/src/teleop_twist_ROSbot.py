...
# bindings for start, stop, reset rosbot
setupBindings={
        '1':('start'),
        '2':('stop'),
        '3':('reset'),
...
class PublishThread(threading.Thread):
    def __init__(self, rate):
        ...
        self.setupPub = rospy.Publisher('cmd_setup', String, queue_size= 1)
        self.x = 0.0
        self.y = 0.0
        self.z = 0.0
        self.th = 0.0
...
if __name__=="__main__":
    ...
    rospy.init_node('teleop_twist_ROSbot')
